...
OnTouch:
	debugmes "OnTouch event triggered";
	set_instance_var("rms",0);
	debugmes "OnTouch event triggered1";
	if(!is_party_leader() || get_instance_var("rms")) end;
	debugmes "OnTouch event triggered2";
	set_instance_var("rms",1);
	debugmes "OnTouch event triggered3";
	instance_enable(strnpcinfo(0),false);
	debugmes "OnTouch event triggered4";
	sleep 2000;
...
1@spa2,28,226,3	script	Memory Piece#rms_0	CLEAR_NPC,{
	...
	switch(.@id){
		case 0:
			...
			next;
			instance_enable("Knight#rms_shard_0");
			mes "[ Princess ]";
			mes "Sakray......";
			npctalk "Princess : Sakray......",.@princess$;
			set_instance_var("memory_" + .@id,1);
			close2;
			instance_enable("Princess#rms_shard_0");
			break;
		...
		case 1:
			...
			next;
			instance_enable("Magic Swordsman#rms_shard_0");
		...
		case 2:
			...
			set_instance_var("memory_" + .@id,1);
			close2;
			instance_enable("Princess#rms_shard_1");
			instance_enable("Marquis#rms_shard_0");
			break;
	}
	end;
}
